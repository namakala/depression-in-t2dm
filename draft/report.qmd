...
- **Insight:**
  ...
  - Meta-regression indicates a growing prevalence of depression at the rate of 0.13% [0 - 0.25%] per year
...
## Grouped by year {#sec-subgroup-year}
...
report_subgroup <- function(mod, meta) {
  ...
  res <- meta %>%
    kable(booktabs = TRUE, longtable = TRUE, escape = FALSE, col.names = c(
      "Label", "N", "Fixed (\\%)", "Random (\\%)", "$I^2$ (\\%)", "$H^2$", "$\\tau^2$"
    )) %>%
